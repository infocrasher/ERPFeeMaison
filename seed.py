...
from models import User, Category, Product, Unit, Recipe, RecipeIngredient, Order, OrderItem
from app.purchases.models import Purchase, PurchaseItem as PurchaseItemModel
...
def seed_data():
    with app.app_context():
        ...
        PurchaseItemModel.query.delete()
        db.session.commit()
